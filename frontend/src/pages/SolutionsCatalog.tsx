    ...
    return (
        <div className="max-w-6xl mx-auto p-6">
            <header className="mb-8">
                <h1 className="text-4xl font-heading font-bold text-primary mb-2">Work Adjustments Catalog</h1>
                <p className="text-xl text-gray-600">Validated solutions to improve workplace inclusion and productivity.</p>
            </header>
